...
TOTAL_TRANSFERS = 50  # how many transfers to fire
# ============================================================
...
def run_one_transfer(conn, transfer_num):
    ...
    try:
        cursor = conn.cursor()
        # Set the OUT param variable first, then CALL, then read it back
...
def main():
    ...
    print("")
    print(line)
    print("  Double-Entry Ledger -- Stress Test")
    ...
    # Single connection, all transfers in sequence
